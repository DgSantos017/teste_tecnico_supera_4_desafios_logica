...
public class Desafio_2_NotasMoedas {

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        scanner.useLocale(Locale.US); // Define o Locale para usar o separador decimal como ponto

        double valor;
        try {
            valor = scanner.nextDouble();
        } catch (InputMismatchException e) {
            System.out.println("Entrada inválida. Insira um valor de ponto flutuante válido.");
            return;
        }
